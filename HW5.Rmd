...
$$ \propto \int \tau^{(n + 1)/2 - 1} exp(-\dfrac{(n +(\beta^T\phi(X^TX)\beta))}{2} \tau) d\tau $$
...
$$ = \Gamma(\dfrac{n + 1}{2}) \Big[(\dfrac{n +(\beta^T\phi(X^TX)\beta)}{2})^{-(n+1)/2}\Big] \propto (n +(\beta^T\phi(X^TX)\beta))^{-(n+1)/2} $$
$$ \propto \Big[1 + \dfrac{\beta^T\phi(X^TX)\beta}{n}\Big]^{-(n+1)/2}$$
