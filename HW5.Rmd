...
ANSWER: a) a) For a short answer, we reference the class notes which provide the posterior  $$ \beta | Y, \phi, g \sim \mathcal{N}\left(\frac{g}{1+g}\hat{\beta},  \frac{g}{1+g}(X^tX)^{-1}\phi^{-1}\right),$$ and $$\beta_0 \, | \, Y, \phi \sim \mathcal{N}(\bar{Y}, I_n/n\phi).$$
