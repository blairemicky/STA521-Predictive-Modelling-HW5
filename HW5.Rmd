...
avg.rmse.bpm = apply(RMSE_BMA, 2, mean)
...
RMSE_BPM = data.frame(beta = RMSE_beta_BPM, mu = RMSE_mu_BPM, test = RMSE_test_BPM)
avg.rmse.zs.bpm = apply(RMSE_BMA, 2, mean)
...
methods = rbind(OLS = avg.rmse.df, AIC = avg_rmse_aic, BIC = avg_rmse_bic, HPM.MCMC = avg.rmse.hpm, BMA.MCMC = avg.rmse.bma, BPM.MCMC = avg.rmse.bpm, HPM.ZS = avg.rmse.zs.hpm, BMA.ZS = avg.rmse.zs.bma, BPM.ZS = avg.rmse.zs.bpm)
