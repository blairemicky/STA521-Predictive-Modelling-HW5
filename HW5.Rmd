...
c) Because  $$ Y^\ast | Y =  (1_n \beta_{0} + X^\ast \beta + \epsilon^\ast )| Y $$ is the sum of two dependent multivariate t-distributions and a Gaussian (for $\epsilon^\ast$), it no longer suffices to compute the mean and variance to characterize the distribution of $Y^\ast | Y$. TBC...
